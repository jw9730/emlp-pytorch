...
class RegressorPlus(Regressor):
    ...
    def __init__(self, model, *args, **kwargs):
        ...
        self.gradvals = objax.Jit(objax.GradValues(
            fastloss, model.vars()), model.vars())
        self.model.predict = objax.Jit(objax.ForceArgs(
            model.__call__, training=False), model.vars())
    ...
    def metrics(self, loader):
        def mse(mb): return np.asarray(jax.device_get(
            jnp.mean((self.model.predict(mb[0])-mb[1])**2)))
