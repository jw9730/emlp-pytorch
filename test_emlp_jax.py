...
def test_equivariance():
    """ Test the EMLP JAX implementation. """
    ...
    for group in test_groups:
        ...
        try:
            test_high_rank_representations(group)
        except AssertionError as e:
            print(e)
    ...
    for group, repin, repout in test_equivariant_matrix_groups:
        ...
        try:
            test_equivariant_matrix_1(group, repin, repout)
        except AssertionError as e:
            print(e)
    ...
    for group, repin, repout in test_bilinear_layer_groups:
        ...
        try:
            test_bilinear_layer(group, repin, repout)
        except AssertionError as e:
            print(e)
    ...
    for group in test_groups:
        ...
        try:
            test_large_representations(group)
        except AssertionError as e:
            print(e)
...
def test_product_groups():
    ...
    for group1, group2 in test_groups:
        ...
        try:
            test_symmetric_mixed_tensor(group1, group2)
        except AssertionError as e:
            print(e)
    ...
    for group1, group2 in test_groups:
        ...
        try:
            test_symmetric_mixed_tensor_sum(group1, group2)
        except AssertionError as e:
            print(e)
    ...
    for group1, group2 in test_groups:
        ...
        try:
            test_symmetric_mixed_products(group1, group2)
        except AssertionError as e:
            print(e)
    ...
    for group1, group2 in test_groups:
        ...
        try:
            test_equivariant_matrix_2(group1, group2)
        except AssertionError as e:
            print(e)
...
def test_model():
    ...
    for dsclass in test_dsclasses:
        ...
        try:
            test_init_forward_and_equivariance(dsclass)
        except AssertionError as e:
            print(e)
